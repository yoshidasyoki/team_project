...
<body class="min-h-screen items-center justify-center bg-cover bg-center bg-no-repeat" style="background-image: url('/resources/img/bg-img.png');">
                ...
                <form action="/articles/update?id=<?= $id ?>" method="POST">
                    <div class="new-post-container bg-white rounded-xl border border-gray-200 p-8">
                                ...
                                <?php foreach ($tags as $tag): ?>
                                    <label
                                        ...
                                        <input
                                            ...
                                            <?= in_array(
                                                $tag['id'],
                                                array_map(fn($tag) => $tag['id'], $checkedTags),
                                                true
                                            ) ? 'checked' : '' ?>>
                        ...
                        <section class="post-main-content-container flex flex-col gap-2 pt-8">
                            ...
                            <textarea class="post-title-input min-h-[40vh] w-full pl-4 pt-4 rounded-xl text-sm border border-gray-200 rounded-lg" type="text" name="body"><?= $body ?></textarea>
                        </section>
                        <section class="post-botton-area flex justify-between py-4">
                            <button class="font-bold px-10 py-2 cursor-pointer">キャンセル</button>
                            <button type="submit" class="bg-[#13283E] text-white font-bold inline-block rounded-lg px-10 py-4 items-centers cursor-pointer">投稿する</button>
                        </section>
                    </div>
                </form>
            </main>
