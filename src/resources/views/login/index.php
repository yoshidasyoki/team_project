...
<body class="min-h-screen flex items-center justify-center bg-cover bg-center bg-no-repeat" style="background-image: url('/resources/img/bg-img.png');">
    <div class="bg-white rounded-2xl shadow-sm p-10 w-full max-w-md z-10">
        ...
        <p class="text-sm text-gray-400 text-center mb-6">アカウントにログインして
            <br>サービスを利用してください。
        </p>
        ...
        <form action="/login/auth" method="POST" class="flex flex-col gap-4">
            ...
            <div class="relative">
                ...
                <input type="text" name="username" placeholder="ユーザー名またはメールアドレス" class="w-full pl-11 pr-4 py-3 border border-gray-200 rounded-xl text-sm outline-none focus:border-[var(--color-primary)]">
            </div>
            ...
            <div class="relative">
                ...
                <input type="password" name="password" id="password" placeholder="パスワード" class="w-full pl-11 pr-11 py-3 border border-gray-200 rounded-xl text-sm outline-none focus:border-[var(--color-primary)]">
        ...
        <a href="/users/create" class="flex items-center justify-center gap-2 mt-4 py-3 border border-gray-200 rounded-xl text-sm text-gray-500 hover:opacity-80">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
